...
/** 
 * DAO for table "FINANCE".
*/
public class FinanceDao extends AbstractDao<Finance, Long> {

    public static final String TABLENAME = "FINANCE";

    /**
     * Properties of entity Finance.<br/>
    ...
    */
    ...
    public FinanceDao(DaoConfig config) {
        super(config);
    }
    
    public FinanceDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FINANCE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FINANCE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Finance entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Finance readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Finance entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Finance entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Finance entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
