...
/** 
 * DAO for table "ENTERTAINMENT".
*/
public class EntertainmentDao extends AbstractDao<Entertainment, Long> {

    public static final String TABLENAME = "ENTERTAINMENT";

    /**
     * Properties of entity Entertainment.<br/>
    ...
    */
    ...
    public EntertainmentDao(DaoConfig config) {
        super(config);
    }
    
    public EntertainmentDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ENTERTAINMENT\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ENTERTAINMENT\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Entertainment entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Entertainment readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Entertainment entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Entertainment entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Entertainment entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
