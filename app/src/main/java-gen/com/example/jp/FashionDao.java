...
public class FashionDao extends AbstractDao<Fashion, Long> {
    ...
    /**
     * Properties of entity Fashion.<br/>
    ...
    */
    ...
    public FashionDao(DaoConfig config) {
        super(config);
    }
    
    public FashionDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FASHION\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FASHION\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Fashion entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Fashion readEntity(Cursor cursor, int offset) {
        Fashion entity = new Fashion( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Fashion entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Fashion entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Fashion entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
